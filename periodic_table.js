...
// ═══════════════════════════════════════════════════════════════════
// ── EXTRA INFO — Element Facts & Uses (all 118 elements) ───────────
// ═══════════════════════════════════════════════════════════════════
// Data source: periodic-table-facts-dataset (elements_hover.json +
//              elements_cards.json) — CC BY 4.0
// Hover data : tagline, uses (2-3), safety note, category
// Card data  : summary, realWorldUses, whereFound, hazards, funHook

const EI_HOVER = {"1":{"tagline":"Fuel of stars; lightest element.","uses":["Ammonia (Haber process)","Rocket fuel","Fuel cells"],"safety":"Forms explosive mixes with O₂","category":"Nonmetal","name":"Hydrogen"},"2":{"tagline":"Discovered in the Sun before Earth.","uses":["MRI magnet cooling","Balloons","Leak detection"],"safety":"Asphyxiation risk in enclosed spaces","category":"Noble Gas","name":"Helium"},"3":{"tagline":"Batteries’ lightweight champion.","uses":["Rechargeable batteries","Alloys","Medicines"],"safety":"Reacts violently with water","category":"Alkali Metal","name":"Lithium"},"4":{"tagline":"Reactive earth metal.","uses":["Alloys","Pyrotechnics"],"safety":"Reacts with acids; some dusts are irritants","category":"Alkaline Earth Metal","name":"Beryllium"},"5":{"tagline":"Between metal and nonmetal—useful in electronics.","uses":["Semiconductors","Glass additives"],"safety":"Some metalloids are toxic","category":"Metalloid","name":"Boron"},"6":{"tagline":"Essential nonmetal for life and materials.","uses":["Fertilizers","Polymers"],"safety":"Varies—some forms are toxic","category":"Nonmetal","name":"Carbon"},"7":{"tagline":"Essential nonmetal for life and materials.","uses":["Fertilizers","Polymers"],"safety":"Varies—some forms are toxic","category":"Nonmetal","name":"Nitrogen"},"8":{"tagline":"Essential nonmetal for life and materials.","uses":["Fertilizers","Polymers"],"safety":"Varies—some forms are toxic","category":"Nonmetal","name":"Oxygen"},"9":{"tagline":"Reactive nonmetal; forms salts.","uses":["Disinfection","Polymers (PVC, PTFE)"],"safety":"Corrosive/toxic as element","category":"Halogen","name":"Fluorine"},"10":{"tagline":"Inert gas used in lighting and shielding.","uses":["Lighting","Welding shields"],"safety":"Asphyxiation risk in confined spaces","category":"Noble Gas","name":"Neon"},"11":{"tagline":"Soft, highly reactive metal.","uses":["Heat transfer","Chemistry reagents"],"safety":"Keep away from water; store under oil","category":"Alkali Metal","name":"Sodium"},"12":{"tagline":"Reactive earth metal.","uses":["Alloys","Pyrotechnics"],"safety":"Reacts with acids; some dusts are irritants","category":"Alkaline Earth Metal","name":"Magnesium"},"13":{"tagline":"Soft, malleable metal with many uses.","uses":["Solders","Coatings"],"safety":"Some compounds can be toxic","category":"Post-Transition Metal","name":"Aluminum"},"14":{"tagline":"Between metal and nonmetal—useful in electronics.","uses":["Semiconductors","Glass additives"],"safety":"Some metalloids are toxic","category":"Metalloid","name":"Silicon"},"15":{"tagline":"Essential nonmetal for life and materials.","uses":["Fertilizers","Polymers"],"safety":"Varies—some forms are toxic","category":"Nonmetal","name":"Phosphorus"},"16":{"tagline":"Essential nonmetal for life and materials.","uses":["Fertilizers","Polymers"],"safety":"Varies—some forms are toxic","category":"Nonmetal","name":"Sulfur"},"17":{"tagline":"Reactive nonmetal; forms salts.","uses":["Disinfection","Polymers (PVC, PTFE)"],"safety":"Corrosive/toxic as element","category":"Halogen","name":"Chlorine"},"18":{"tagline":"Inert gas used in lighting and shielding.","uses":["Lighting","Welding shields"],"safety":"Asphyxiation risk in confined spaces","category":"Noble Gas","name":"Argon"},"19":{"tagline":"Soft, highly reactive metal.","uses":["Heat transfer","Chemistry reagents"],"safety":"Keep away from water; store under oil","category":"Alkali Metal","name":"Potassium"},"20":{"tagline":"Reactive earth metal.","uses":["Alloys","Pyrotechnics"],"safety":"Reacts with acids; some dusts are irritants","category":"Alkaline Earth Metal","name":"Calcium"},"21":{"tagline":"Light, strong alloying addition.","uses":["Al‑Sc alloys","Sports equipment"],"safety":"Dust irritant","category":"Transition Metal","name":"Scandium"},"22":{"tagline":"Strong as steel, half the weight.","uses":["Implants","Aerospace"],"safety":"Dust sparks; welding fumes","category":"Transition Metal","name":"Titanium"},"23":{"tagline":"Boosts steel strength.","uses":["Tool steels","Vanadium redox batteries"],"safety":"Compound toxicity","category":"Transition Metal","name":"Vanadium"},"24":{"tagline":"Stainless sparkle.","uses":["Stainless steel","Plating"],"safety":"Hex‑Cr compounds toxic","category":"Transition Metal","name":"Chromium"},"25":{"tagline":"Hardens steels and batteries.","uses":["Steelmaking","Alkaline batteries"],"safety":"Dust irritant","category":"Transition Metal","name":"Manganese"},"26":{"tagline":"Heart of steel.","uses":["Construction","Tools"],"safety":"Rust dust irritant","category":"Transition Metal","name":"Iron"},"27":{"tagline":"Battery cathodes & blue glass.","uses":["Li‑ion batteries","Alloys"],"safety":"Toxic in dust/soluble salts","category":"Transition Metal","name":"Cobalt"},"28":{"tagline":"Resists corrosion; coins to catalysts.","uses":["Stainless steel","Alloys"],"safety":"Allergy risk (nickel)","category":"Transition Metal","name":"Nickel"},"29":{"tagline":"Top‑tier electrical conductor.","uses":["Wiring","Plumbing"],"safety":"Patina not harmful; dust irritant","category":"Transition Metal","name":"Copper"},"30":{"tagline":"Galvanizes steel against rust.","uses":["Galvanization","Brass"],"safety":"Fume fever risk when welding","category":"Transition Metal","name":"Zinc"},"31":{"tagline":"Melts in your hand.","uses":["Semiconductors (GaAs)","LEDs (GaN)"],"safety":"Low toxicity; stains","category":"Post-Transition Metal","name":"Gallium"},"32":{"tagline":"Early transistor hero.","uses":["Fiber optics","IR optics"],"safety":"Dust caution","category":"Metalloid","name":"Germanium"},"33":{"tagline":"Toxic metalloid; microchips.","uses":["Semiconductors (GaAs)","Preservatives (historic)"],"safety":"Toxic","category":"Metalloid","name":"Arsenic"},"34":{"tagline":"From photocells to nutrition.","uses":["Glass decolorizer","Electronics"],"safety":"Overexposure causes selenosis","category":"Nonmetal","name":"Selenium"},"35":{"tagline":"Only liquid nonmetal.","uses":["Flame retardants","Photography (AgBr)"],"safety":"Corrosive/toxic vapors","category":"Halogen","name":"Bromine"},"36":{"tagline":"Rare gas for bright flashes.","uses":["Photography","Excimer lasers"],"safety":"Asphyxiation risk","category":"Noble Gas","name":"Krypton"},"37":{"tagline":"Super reactive; atomic clocks.","uses":["Atomic clocks (Rb)","Vacuum tubes (getter)"],"safety":"Reacts with moisture","category":"Alkali Metal","name":"Rubidium"},"38":{"tagline":"Red fireworks star.","uses":["Pyrotechnics","Ceramic magnets"],"safety":"Salts vary in toxicity","category":"Alkaline Earth Metal","name":"Strontium"},"39":{"tagline":"Phosphors & ceramics.","uses":["YAG lasers","LED phosphors"],"safety":"Dust irritant","category":"Transition Metal","name":"Yttrium"},"40":{"tagline":"Nuclear cladding metal.","uses":["Nuclear fuel cladding","Ceramics"],"safety":"Dust irritant","category":"Transition Metal","name":"Zirconium"},"41":{"tagline":"Superconducting magnets.","uses":["Nb‑Ti/Nb₃Sn magnets","Steel alloys"],"safety":"Dust caution","category":"Transition Metal","name":"Niobium"},"42":{"tagline":"High‑temp strength booster.","uses":["Alloys","Catalysts"],"safety":"Dust caution","category":"Transition Metal","name":"Molybdenum"},"43":{"tagline":"First made by humans.","uses":["Medical imaging","Corrosion testing"],"safety":"Radioactive","category":"Transition Metal","name":"Technetium"},"44":{"tagline":"Electronics hardener.","uses":["Platinum‑group catalysts","Hardening alloys"],"safety":"Compound toxicity","category":"Transition Metal","name":"Ruthenium"},"45":{"tagline":"Catalytic converter MVP.","uses":["Auto catalysts","Jewelry plating"],"safety":"Expensive; fume hazard","category":"Transition Metal","name":"Rhodium"},"46":{"tagline":"Hydrogen sponge & catalyst.","uses":["Catalytic converters","Hydrogenation"],"safety":"Allergy risk","category":"Transition Metal","name":"Palladium"},"47":{"tagline":"Best electrical conductor.","uses":["Electronics","Photography (historic)"],"safety":"Silver compounds can stain skin","category":"Transition Metal","name":"Silver"},"48":{"tagline":"Pigments and batteries (old).","uses":["Ni‑Cd batteries","Stabilizers (historic)"],"safety":"Toxic—restricted","category":"Transition Metal","name":"Cadmium"},"49":{"tagline":"Touchscreen enabler.","uses":["ITO coatings","Low‑melting alloys"],"safety":"Low acute toxicity","category":"Post-Transition Metal","name":"Indium"},"50":{"tagline":"Solder and tinplate.","uses":["Solder","Tin cans (coating)"],"safety":"Fume hazard when soldering","category":"Post-Transition Metal","name":"Tin"},"51":{"tagline":"Flame‑retardant chemistries.","uses":["Alloys","Flame retardants"],"safety":"Toxic in some forms","category":"Metalloid","name":"Antimony"},"52":{"tagline":"Solar cells and metallurgy.","uses":["CdTe solar","Steel alloying"],"safety":"Toxic in some compounds","category":"Metalloid","name":"Tellurium"},"53":{"tagline":"Thyroid essential; antiseptic.","uses":["Diet (iodized salt)","Medical contrast"],"safety":"Excess can irritate thyroid","category":"Halogen","name":"Iodine"},"54":{"tagline":"Bright lamps and anesthesia.","uses":["High‑intensity lamps","Anesthetic"],"safety":"Asphyxiation risk","category":"Noble Gas","name":"Xenon"},"55":{"tagline":"Standard of time.","uses":["Atomic clocks","Photoelectric cells (historic)"],"safety":"Highly reactive","category":"Alkali Metal","name":"Cesium"},"56":{"tagline":"Green fireworks and imaging.","uses":["Drilling fluids","BaSO₄ contrast"],"safety":"Soluble salts toxic","category":"Alkaline Earth Metal","name":"Barium"},"57":{"tagline":"Camera glass and catalysts.","uses":["Lenses","Petroleum cracking"],"safety":"Dust caution","category":"Lanthanide","name":"Lanthanum"},"58":{"tagline":"Lighter flints and polish.","uses":["Ferrocerium flints","Glass polishing"],"safety":"Dust caution","category":"Lanthanide","name":"Cerium"},"59":{"tagline":"Magnet helper and glass tint.","uses":["Magnets","Didymium glass"],"safety":"Dust caution","category":"Lanthanide","name":"Praseodymium"},"60":{"tagline":"Super strong magnets.","uses":["NdFeB magnets","Headphones"],"safety":"Dust flammable","category":"Lanthanide","name":"Neodymium"},"61":{"tagline":"Radioactive rare earth.","uses":["Nuclear batteries (beta)","Research"],"safety":"Radioactive","category":"Lanthanide","name":"Promethium"},"62":{"tagline":"Magnets and neutron capture.","uses":["SmCo magnets","Control rods"],"safety":"Dust caution","category":"Lanthanide","name":"Samarium"},"63":{"tagline":"Red in your screens.","uses":["Display phosphors","Anti‑counterfeiting"],"safety":"Low toxicity","category":"Lanthanide","name":"Europium"},"64":{"tagline":"MRI contrast metal.","uses":["Gd chelates (MRI)","Magnets"],"safety":"Free ion toxic; chelates safer","category":"Lanthanide","name":"Gadolinium"},"65":{"tagline":"Green phosphors & speakers.","uses":["Phosphors","Magnetostrictive devices"],"safety":"Dust caution","category":"Lanthanide","name":"Terbium"},"66":{"tagline":"Magnet stabilizer.","uses":["Nd magnet addendum","Lasers"],"safety":"Dust caution","category":"Lanthanide","name":"Dysprosium"},"67":{"tagline":"Huge magnetic moment.","uses":["Magnets","NMR alignment"],"safety":"Dust caution","category":"Lanthanide","name":"Holmium"},"68":{"tagline":"Fiber‑optic amplifier.","uses":["Er‑doped fiber amplifiers","Lasers"],"safety":"Dust caution","category":"Lanthanide","name":"Erbium"},"69":{"tagline":"Portable X‑ray source.","uses":["Radiography (historic)","Lasers"],"safety":"Radioactive sources handled by experts","category":"Lanthanide","name":"Thulium"},"70":{"tagline":"Quiet clocks & lasers.","uses":["Atomic clocks (Yb)","Fiber lasers"],"safety":"Dust caution","category":"Lanthanide","name":"Ytterbium"},"71":{"tagline":"Scintillators and catalysis.","uses":["Petrochemical catalysts","Scintillator crystals"],"safety":"Dust caution","category":"Lanthanide","name":"Lutetium"},"72":{"tagline":"Nuclear control partner.","uses":["Alloys with Zr","Plasma cutting tips"],"safety":"Dust caution","category":"Transition Metal","name":"Hafnium"},"73":{"tagline":"Reliable capacitors.","uses":["Electronics capacitors","Surgical tools"],"safety":"Dust/fume toxicity","category":"Transition Metal","name":"Tantalum"},"74":{"tagline":"Highest melting metal.","uses":["Lamp filaments","Cutting tools"],"safety":"Dust hazard","category":"Transition Metal","name":"Tungsten"},"75":{"tagline":"Jet engine ally.","uses":["Superalloys","Thermocouples"],"safety":"Dust toxicity","category":"Transition Metal","name":"Rhenium"},"76":{"tagline":"Densest hard metal.","uses":["Pen tips (historic)","Catalyst (OsO₄)"],"safety":"OsO₄ is highly toxic","category":"Transition Metal","name":"Osmium"},"77":{"tagline":"Almost corrosion‑proof.","uses":["Spark plugs","Crucibles"],"safety":"Dust caution","category":"Transition Metal","name":"Iridium"},"78":{"tagline":"Catalyst & jewelry elite.","uses":["Catalytic converters","Labware"],"safety":"Sensitizer risk","category":"Transition Metal","name":"Platinum"},"79":{"tagline":"Inert, shiny, and conductive.","uses":["Electronics","Dentistry"],"safety":"Low reactivity","category":"Transition Metal","name":"Gold"},"80":{"tagline":"Liquid metal at room temp.","uses":["Thermometers (historic)","Switches"],"safety":"Highly toxic—vapors harmful","category":"Transition Metal","name":"Mercury"},"81":{"tagline":"Optics and electronics (but toxic).","uses":["Infrared optics","Semiconductors"],"safety":"Highly toxic","category":"Post-Transition Metal","name":"Thallium"},"82":{"tagline":"Dense shield and battery metal.","uses":["Radiation shielding","Batteries"],"safety":"Toxic—especially to children","category":"Post-Transition Metal","name":"Lead"},"83":{"tagline":"Low‑tox heavy metal.","uses":["Medicines (bismuth subsalicylate)","Low‑melt alloys"],"safety":"Generally low toxicity","category":"Post-Transition Metal","name":"Bismuth"},"84":{"tagline":"Deadly alpha emitter.","uses":["Heat sources (limited)","Research"],"safety":"Highly radioactive","category":"Metalloid","name":"Polonium"},"85":{"tagline":"Rarest natural halogen.","uses":["Research only"],"safety":"Radioactive","category":"Halogen","name":"Astatine"},"86":{"tagline":"Radioactive noble gas.","uses":["Geology tracing","Therapy (limited)"],"safety":"Causes lung cancer in homes","category":"Noble Gas","name":"Radon"},"87":{"tagline":"Ephemeral alkali metal.","uses":["Research"],"safety":"Highly radioactive","category":"Alkali Metal","name":"Francium"},"88":{"tagline":"Glow‑in‑the‑dark (historic).","uses":["Radiotherapy (historic)","Research"],"safety":"Highly radioactive","category":"Alkaline Earth Metal","name":"Radium"},"89":{"tagline":"Radiation therapy research.","uses":["Radiotherapy","Neutron sources"],"safety":"Radioactive","category":"Actinide","name":"Actinium"},"90":{"tagline":"Potential reactor fuel.","uses":["Molten‑salt reactor fuel","Gas mantles (historic)"],"safety":"Radioactive","category":"Actinide","name":"Thorium"},"91":{"tagline":"Rare and short‑lived.","uses":["Research"],"safety":"Radioactive","category":"Actinide","name":"Protactinium"},"92":{"tagline":"Nuclear workhorse.","uses":["Reactor fuel","Armor piercing"],"safety":"Radioactive & toxic","category":"Actinide","name":"Uranium"},"93":{"tagline":"Reactor byproduct.","uses":["Detectors","Research"],"safety":"Radioactive","category":"Actinide","name":"Neptunium"},"94":{"tagline":"RTGs and weapons history.","uses":["Space power (Pu‑238)","MOX fuel"],"safety":"Radioactive & toxic","category":"Actinide","name":"Plutonium"},"95":{"tagline":"Smoke detector source.","uses":["Ionization smoke detectors"],"safety":"Radioactive","category":"Actinide","name":"Americium"},"96":{"tagline":"Hot micro power.","uses":["RTG heat sources","Research"],"safety":"Radioactive","category":"Actinide","name":"Curium"},"97":{"tagline":"Lab‑made rare earth.","uses":["Research"],"safety":"Radioactive","category":"Actinide","name":"Berkelium"},"98":{"tagline":"Portable neutron source.","uses":["Cf‑252 neutron emitters"],"safety":"Radioactive","category":"Actinide","name":"Californium"},"99":{"tagline":"Glows under its own radiation.","uses":["Research"],"safety":"Radioactive","category":"Actinide","name":"Einsteinium"},"100":{"tagline":"Short‑lived lab element.","uses":["Research"],"safety":"Radioactive","category":"Actinide","name":"Fermium"},"101":{"tagline":"Named for Mendeleev.","uses":["Research"],"safety":"Radioactive","category":"Actinide","name":"Mendelevium"},"102":{"tagline":"Nobel namesake.","uses":["Research"],"safety":"Radioactive","category":"Actinide","name":"Nobelium"},"103":{"tagline":"Actinide endcap.","uses":["Research"],"safety":"Radioactive","category":"Actinide","name":"Lawrencium"},"104":{"tagline":"Superheavy, fleeting.","uses":["Research"],"safety":"Radioactive","category":"Transition Metal","name":"Rutherfordium"},"105":{"tagline":"Dubna discovery.","uses":["Research"],"safety":"Radioactive","category":"Transition Metal","name":"Dubnium"},"106":{"tagline":"Seaborg honored in life.","uses":["Research"],"safety":"Radioactive","category":"Transition Metal","name":"Seaborgium"},"107":{"tagline":"A nod to Bohrian physics.","uses":["Research"],"safety":"Radioactive","category":"Transition Metal","name":"Bohrium"},"108":{"tagline":"Heavy and short‑lived.","uses":["Research"],"safety":"Radioactive","category":"Transition Metal","name":"Hassium"},"109":{"tagline":"Meitner recognized.","uses":["Research"],"safety":"Radioactive","category":"Transition Metal","name":"Meitnerium"},"110":{"tagline":"Darmstadt discovery.","uses":["Research"],"safety":"Radioactive","category":"Transition Metal","name":"Darmstadtium"},"111":{"tagline":"X‑ray pioneer namesake.","uses":["Research"],"safety":"Radioactive","category":"Transition Metal","name":"Roentgenium"},"112":{"tagline":"Copernicus celebrated.","uses":["Research"],"safety":"Radioactive (likely volatile)","category":"Post-Transition Metal","name":"Copernicium"},"113":{"tagline":"First named in Asia.","uses":["Research"],"safety":"Radioactive","category":"Post-Transition Metal","name":"Nihonium"},"114":{"tagline":"Superheavy, metal‑like.","uses":["Research"],"safety":"Radioactive","category":"Post-Transition Metal","name":"Flerovium"},"115":{"tagline":"From Moscow region.","uses":["Research"],"safety":"Radioactive","category":"Post-Transition Metal","name":"Moscovium"},"116":{"tagline":"Livermore’s namesake.","uses":["Research"],"safety":"Radioactive","category":"Post-Transition Metal","name":"Livermorium"},"117":{"tagline":"Heavy halogen cousin.","uses":["Research"],"safety":"Radioactive","category":"Halogen","name":"Tennessine"},"118":{"tagline":"Heaviest noble gas (maybe).","uses":["Research"],"safety":"Radioactive","category":"Noble Gas","name":"Oganesson"}};

const EI_CARDS = {"1":{"summary":"Hydrogen makes up ~75% of the observable universe and is the primary fuel for stellar fusion.","uses":["Ammonia production for fertilizers","Hydrogen fuel cells and future energy storage","Rocket propellant (liquid H₂)","Hydrotreating in oil refining"],"where":["Stars and gas giants","Trace in Earth’s atmosphere","Bound in water and organic compounds"],"hazards":["Flammable; wide explosive limits in air","Liquid hydrogen is extremely cold (cryogenic)"],"fun":"The Sun fuses ~600 million tons of hydrogen into helium every second."},"2":{"summary":"Helium is an inert noble gas with the lowest boiling point of any element, critical for cryogenics.","uses":["Coolant for superconducting MRI magnets","Pressurizing and purging rocket fuel systems","Helium–neon lasers","Leak detection in vacuum systems"],"where":["Natural gas deposits (alpha decay product)","Escape to space from atmosphere"],"hazards":["Non-toxic but displaces oxygen","Finite resource—once released, it escapes Earth"],"fun":"Helium’s spectral lines were seen in solar light in 1868—before it was isolated on Earth."},"3":{"summary":"Lithium is the lightest metal, crucial for high energy-density rechargeable batteries.","uses":["Li‑ion batteries for phones, laptops, EVs","Lightweight aerospace alloys","Mood‑stabilizing medications (lithium salts)","Greases and air treatment (lithium hydroxide)"],"where":["Brines and salt flats","Pegmatite minerals (spodumene)"],"hazards":["Highly reactive with water and air","Battery thermal runaway risks"],"fun":"Lithium metal floats on water—before it violently reacts!"},"4":{"summary":"These metals are harder than alkali metals and form characteristic flame colors.","uses":["Fireworks colors (Sr=red, Ba=green)","Light alloys (Mg)","Cements and plasters (Ca compounds)"],"where":["Common minerals and ores"],"hazards":["Powders can be flammable","Some salts are toxic (Ba²⁺)"],"fun":"Many give vivid flame-test colors—great for demos."},"5":{"summary":"Metalloids have mixed metallic/nonmetallic properties; many are essential in semiconductors.","uses":["Silicon chips and solar cells","Infrared optics (Ge)","Flame retardants (Sb/As compounds)"],"where":["Silicate rocks, sulfide minerals"],"hazards":["Arsenic and antimony compounds are poisonous"],"fun":"Silicon literally powers the digital world."},"6":{"summary":"Nonmetals include the building blocks of life and key industrial chemicals.","uses":["Life chemistry (C, N, O)","Acids, disinfectants, and polymers"],"where":["Air, water, minerals, living things"],"hazards":["Choking/asphyxiation or reactive gases (Cl₂, F₂)"],"fun":"Allotropes can have wildly different properties (carbon!)."},"7":{"summary":"Nonmetals include the building blocks of life and key industrial chemicals.","uses":["Life chemistry (C, N, O)","Acids, disinfectants, and polymers"],"where":["Air, water, minerals, living things"],"hazards":["Choking/asphyxiation or reactive gases (Cl₂, F₂)"],"fun":"Allotropes can have wildly different properties (carbon!)."},"8":{"summary":"Nonmetals include the building blocks of life and key industrial chemicals.","uses":["Life chemistry (C, N, O)","Acids, disinfectants, and polymers"],"where":["Air, water, minerals, living things"],"hazards":["Choking/asphyxiation or reactive gases (Cl₂, F₂)"],"fun":"Allotropes can have wildly different properties (carbon!)."},"9":{"summary":"Halogens are highly reactive diatomic elements that form salts with metals.","uses":["Water treatment and disinfectants","Plastics (PVC) and nonstick coatings (PTFE)","Halogen lamps"],"where":["Sea salt deposits, brines"],"hazards":["Elemental forms can be corrosive/toxic","Some organohalogens persist in environment"],"fun":"Fluorine is the most reactive element known."},"10":{"summary":"Noble gases are very unreactive; they shine (literally) in lighting and protect hot metals from air.","uses":["Neon signs, high‑intensity lamps","Shielding gas for welding (Ar)","Cryogenics (He)"],"where":["Air separation","Natural gas (He)"],"hazards":["Displace oxygen in enclosed spaces"],"fun":"Each noble gas gives a different colored glow in discharge tubes."},"11":{"summary":"Alkali metals are very reactive, soft metals that form strong bases with water.","uses":["Specialty chemical synthesis","Photoelectric cells or atomic clocks (Cs, Rb)","Vapour lamps (Na)"],"where":["Ionic salts in minerals","Electrolysis or reduction to isolate"],"hazards":["React violently with water","Form caustic hydroxides"],"fun":"They get more reactive as you go down the group."},"12":{"summary":"These metals are harder than alkali metals and form characteristic flame colors.","uses":["Fireworks colors (Sr=red, Ba=green)","Light alloys (Mg)","Cements and plasters (Ca compounds)"],"where":["Common minerals and ores"],"hazards":["Powders can be flammable","Some salts are toxic (Ba²⁺)"],"fun":"Many give vivid flame-test colors—great for demos."},"13":{"summary":"These metals are softer and have lower melting points than most transition metals.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"14":{"summary":"Metalloids have mixed metallic/nonmetallic properties; many are essential in semiconductors.","uses":["Silicon chips and solar cells","Infrared optics (Ge)","Flame retardants (Sb/As compounds)"],"where":["Silicate rocks, sulfide minerals"],"hazards":["Arsenic and antimony compounds are poisonous"],"fun":"Silicon literally powers the digital world."},"15":{"summary":"Nonmetals include the building blocks of life and key industrial chemicals.","uses":["Life chemistry (C, N, O)","Acids, disinfectants, and polymers"],"where":["Air, water, minerals, living things"],"hazards":["Choking/asphyxiation or reactive gases (Cl₂, F₂)"],"fun":"Allotropes can have wildly different properties (carbon!)."},"16":{"summary":"Nonmetals include the building blocks of life and key industrial chemicals.","uses":["Life chemistry (C, N, O)","Acids, disinfectants, and polymers"],"where":["Air, water, minerals, living things"],"hazards":["Choking/asphyxiation or reactive gases (Cl₂, F₂)"],"fun":"Allotropes can have wildly different properties (carbon!)."},"17":{"summary":"Halogens are highly reactive diatomic elements that form salts with metals.","uses":["Water treatment and disinfectants","Plastics (PVC) and nonstick coatings (PTFE)","Halogen lamps"],"where":["Sea salt deposits, brines"],"hazards":["Elemental forms can be corrosive/toxic","Some organohalogens persist in environment"],"fun":"Fluorine is the most reactive element known."},"18":{"summary":"Noble gases are very unreactive; they shine (literally) in lighting and protect hot metals from air.","uses":["Neon signs, high‑intensity lamps","Shielding gas for welding (Ar)","Cryogenics (He)"],"where":["Air separation","Natural gas (He)"],"hazards":["Displace oxygen in enclosed spaces"],"fun":"Each noble gas gives a different colored glow in discharge tubes."},"19":{"summary":"Alkali metals are very reactive, soft metals that form strong bases with water.","uses":["Specialty chemical synthesis","Photoelectric cells or atomic clocks (Cs, Rb)","Vapour lamps (Na)"],"where":["Ionic salts in minerals","Electrolysis or reduction to isolate"],"hazards":["React violently with water","Form caustic hydroxides"],"fun":"They get more reactive as you go down the group."},"20":{"summary":"These metals are harder than alkali metals and form characteristic flame colors.","uses":["Fireworks colors (Sr=red, Ba=green)","Light alloys (Mg)","Cements and plasters (Ca compounds)"],"where":["Common minerals and ores"],"hazards":["Powders can be flammable","Some salts are toxic (Ba²⁺)"],"fun":"Many give vivid flame-test colors—great for demos."},"21":{"summary":"Scandium refines grain structure in aluminum alloys; used in high‑performance parts.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"22":{"summary":"Titanium forms a protective oxide, making it corrosion resistant and biocompatible.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"23":{"summary":"Vanadium improves steel and enables flow batteries for grid storage.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"24":{"summary":"Chromium gives corrosion resistance and vivid pigments (with safety considerations).","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"25":{"summary":"Manganese is essential in steel and as a cathode material.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"26":{"summary":"Iron’s alloys built the modern world; Fe is central to hemoglobin.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"27":{"summary":"Cobalt colors glass deep blue; modern use in battery cathodes.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"28":{"summary":"Nickel strengthens stainless steel and appears in coins and catalysts.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"29":{"summary":"Copper’s conductivity makes it essential for power grids and electronics.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"30":{"summary":"Zinc protects steel and is a trace nutrient in the human body.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"31":{"summary":"Gallium wets glass and forms key semiconductors for LEDs and lasers.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"32":{"summary":"Germanium enabled the first transistors; still used in optics and detectors.","uses":["Silicon chips and solar cells","Infrared optics (Ge)","Flame retardants (Sb/As compounds)"],"where":["Silicate rocks, sulfide minerals"],"hazards":["Arsenic and antimony compounds are poisonous"],"fun":"Silicon literally powers the digital world."},"33":{"summary":"Arsenic compounds are poisonous; carefully handled in semiconductor industry.","uses":["Silicon chips and solar cells","Infrared optics (Ge)","Flame retardants (Sb/As compounds)"],"where":["Silicate rocks, sulfide minerals"],"hazards":["Arsenic and antimony compounds are poisonous"],"fun":"Silicon literally powers the digital world."},"34":{"summary":"Selenium is a photoconductor and an essential trace element.","uses":["Life chemistry (C, N, O)","Acids, disinfectants, and polymers"],"where":["Air, water, minerals, living things"],"hazards":["Choking/asphyxiation or reactive gases (Cl₂, F₂)"],"fun":"Allotropes can have wildly different properties (carbon!)."},"35":{"summary":"Bromine forms salts used in films and some flame retardants (with environmental review).","uses":["Water treatment and disinfectants","Plastics (PVC) and nonstick coatings (PTFE)","Halogen lamps"],"where":["Sea salt deposits, brines"],"hazards":["Elemental forms can be corrosive/toxic","Some organohalogens persist in environment"],"fun":"Fluorine is the most reactive element known."},"36":{"summary":"Krypton produces bright light in flash lamps and specialized lasers.","uses":["Neon signs, high‑intensity lamps","Shielding gas for welding (Ar)","Cryogenics (He)"],"where":["Air separation","Natural gas (He)"],"hazards":["Displace oxygen in enclosed spaces"],"fun":"Each noble gas gives a different colored glow in discharge tubes."},"37":{"summary":"Rubidium is used in timing standards and as a getter in vacuum systems.","uses":["Specialty chemical synthesis","Photoelectric cells or atomic clocks (Cs, Rb)","Vapour lamps (Na)"],"where":["Ionic salts in minerals","Electrolysis or reduction to isolate"],"hazards":["React violently with water","Form caustic hydroxides"],"fun":"They get more reactive as you go down the group."},"38":{"summary":"Strontium salts color fireworks red; Sr‑90 is a hazardous fission product.","uses":["Fireworks colors (Sr=red, Ba=green)","Light alloys (Mg)","Cements and plasters (Ca compounds)"],"where":["Common minerals and ores"],"hazards":["Powders can be flammable","Some salts are toxic (Ba²⁺)"],"fun":"Many give vivid flame-test colors—great for demos."},"39":{"summary":"Yttrium is key in phosphors and high‑temperature ceramics.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"40":{"summary":"Zirconium resists corrosion and absorbs little neutrons—ideal for fuel rods.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"41":{"summary":"Niobium forms superconductors for MRI and fusion magnets.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"42":{"summary":"Molybdenum strengthens steels and serves in enzymes and catalysts.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"43":{"summary":"Technetium has no stable isotopes; used in nuclear medicine (Tc‑99m).","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"44":{"summary":"Ruthenium improves hardness and durability; used in chip contacts and catalysts.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"45":{"summary":"Rhodium is superb for reducing NOx in exhaust systems.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"46":{"summary":"Palladium absorbs hydrogen and catalyzes many reactions.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"47":{"summary":"Silver is unmatched for conductivity and has antimicrobial properties.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"48":{"summary":"Cadmium is toxic; usage has declined due to regulations.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"49":{"summary":"Indium tin oxide makes transparent electrodes in screens and solar cells.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"50":{"summary":"Tin resists corrosion and has a distinctive ‘tin cry’ when bent.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"51":{"summary":"Antimony trioxide is a common flame‑retardant synergist.","uses":["Silicon chips and solar cells","Infrared optics (Ge)","Flame retardants (Sb/As compounds)"],"where":["Silicate rocks, sulfide minerals"],"hazards":["Arsenic and antimony compounds are poisonous"],"fun":"Silicon literally powers the digital world."},"52":{"summary":"Tellurium improves machinability and features in thin‑film photovoltaics.","uses":["Silicon chips and solar cells","Infrared optics (Ge)","Flame retardants (Sb/As compounds)"],"where":["Silicate rocks, sulfide minerals"],"hazards":["Arsenic and antimony compounds are poisonous"],"fun":"Silicon literally powers the digital world."},"53":{"summary":"Iodine prevents goiter and disinfects; also used in imaging agents.","uses":["Water treatment and disinfectants","Plastics (PVC) and nonstick coatings (PTFE)","Halogen lamps"],"where":["Sea salt deposits, brines"],"hazards":["Elemental forms can be corrosive/toxic","Some organohalogens persist in environment"],"fun":"Fluorine is the most reactive element known."},"54":{"summary":"Xenon makes brilliant light and serves as a rare, gentle anesthetic.","uses":["Neon signs, high‑intensity lamps","Shielding gas for welding (Ar)","Cryogenics (He)"],"where":["Air separation","Natural gas (He)"],"hazards":["Displace oxygen in enclosed spaces"],"fun":"Each noble gas gives a different colored glow in discharge tubes."},"55":{"summary":"Cesium defines the SI second via its atomic transition.","uses":["Specialty chemical synthesis","Photoelectric cells or atomic clocks (Cs, Rb)","Vapour lamps (Na)"],"where":["Ionic salts in minerals","Electrolysis or reduction to isolate"],"hazards":["React violently with water","Form caustic hydroxides"],"fun":"They get more reactive as you go down the group."},"56":{"summary":"Barium salts color fireworks green; BaSO₄ is used as a radiographic contrast agent.","uses":["Fireworks colors (Sr=red, Ba=green)","Light alloys (Mg)","Cements and plasters (Ca compounds)"],"where":["Common minerals and ores"],"hazards":["Powders can be flammable","Some salts are toxic (Ba²⁺)"],"fun":"Many give vivid flame-test colors—great for demos."},"57":{"summary":"Lanthanum improves optical glass and refines fuels.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"58":{"summary":"Cerium sparks in lighter flints and polishes precision optics.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"59":{"summary":"Praseodymium aids high‑performance magnets and tints safety glass.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"60":{"summary":"Neodymium magnets are among the strongest permanent magnets.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"61":{"summary":"Promethium is synthetic; used in luminous signs (historic) and research.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"62":{"summary":"Samarium makes high‑temp magnets and absorbs neutrons.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"63":{"summary":"Europium gives red/blue hues in LEDs and fluorescent lamps.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"64":{"summary":"Gadolinium’s magnetic properties brighten MRI images.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"65":{"summary":"Terbium gives green in displays and helps transducers.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"66":{"summary":"Dysprosium helps magnets retain strength at high temperatures.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"67":{"summary":"Holmium has the largest magnetic moment of any element.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"68":{"summary":"Erbium enables long‑distance optical communications.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"69":{"summary":"Thulium can power small X‑ray devices when activated.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"70":{"summary":"Ytterbium is used in precision timekeeping and efficient lasers.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"71":{"summary":"Lutetium forms dense scintillators used in PET scanners.","uses":["Neodymium magnets (Nd, Pr, Dy)","Color phosphors in screens (Eu, Tb)","MRI contrast (Gd)"],"where":["Monazite/bastnäsite ores"],"hazards":["Dust can irritate","Some compounds are mildly toxic"],"fun":"Despite the name, many are fairly common—but hard to separate."},"72":{"summary":"Hafnium’s neutron absorption makes it useful in control rods.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"73":{"summary":"Tantalum resists corrosion and stores charge densely in capacitors.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"74":{"summary":"Tungsten withstands heat in lamps and drill bits.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"75":{"summary":"Rhenium boosts superalloy strength at high temperatures.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"76":{"summary":"Osmium is extremely dense; its tetroxide stains and is dangerous.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"77":{"summary":"Iridium survives harsh conditions and marks meteor impact layers.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"78":{"summary":"Platinum catalyzes key reactions and resists corrosion.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"79":{"summary":"Gold resists tarnish, ideal for high‑reliability contacts.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"80":{"summary":"Mercury was used in instruments; use restricted due to toxicity.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"81":{"summary":"Thallium compounds are extremely toxic; use is tightly controlled.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"82":{"summary":"Lead blocks radiation and once raised octane in gasoline (now banned).","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"83":{"summary":"Bismuth is one of the least toxic heavy metals; forms fusible alloys.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"84":{"summary":"Polonium’s alpha radiation is extremely hazardous internally.","uses":["Silicon chips and solar cells","Infrared optics (Ge)","Flame retardants (Sb/As compounds)"],"where":["Silicate rocks, sulfide minerals"],"hazards":["Arsenic and antimony compounds are poisonous"],"fun":"Silicon literally powers the digital world."},"85":{"summary":"Astatine exists only in trace amounts; mainly studied in labs, potential in targeted therapy.","uses":["Water treatment and disinfectants","Plastics (PVC) and nonstick coatings (PTFE)","Halogen lamps"],"where":["Sea salt deposits, brines"],"hazards":["Elemental forms can be corrosive/toxic","Some organohalogens persist in environment"],"fun":"Fluorine is the most reactive element known."},"86":{"summary":"Radon seeps from rocks; building ventilation reduces risk.","uses":["Neon signs, high‑intensity lamps","Shielding gas for welding (Ar)","Cryogenics (He)"],"where":["Air separation","Natural gas (He)"],"hazards":["Displace oxygen in enclosed spaces"],"fun":"Each noble gas gives a different colored glow in discharge tubes."},"87":{"summary":"Francium is so rare it’s studied atom‑by‑atom.","uses":["Specialty chemical synthesis","Photoelectric cells or atomic clocks (Cs, Rb)","Vapour lamps (Na)"],"where":["Ionic salts in minerals","Electrolysis or reduction to isolate"],"hazards":["React violently with water","Form caustic hydroxides"],"fun":"They get more reactive as you go down the group."},"88":{"summary":"Radium once illuminated watch dials—now a cautionary tale.","uses":["Fireworks colors (Sr=red, Ba=green)","Light alloys (Mg)","Cements and plasters (Ca compounds)"],"where":["Common minerals and ores"],"hazards":["Powders can be flammable","Some salts are toxic (Ba²⁺)"],"fun":"Many give vivid flame-test colors—great for demos."},"89":{"summary":"Actinium emits intense radiation useful in targeted therapies.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"90":{"summary":"Thorium is being explored as an alternative nuclear fuel.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"91":{"summary":"Protactinium occurs in trace amounts; studied for nuclear science.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"92":{"summary":"Uranium powers reactors; depleted U is very dense for shielding.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"93":{"summary":"Neptunium forms in reactors and helps study transuranics.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"94":{"summary":"Plutonium powered deep‑space probes and has a complex history.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"95":{"summary":"Americium‑241 ionizes air to detect smoke particles.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"96":{"summary":"Curium isotopes produce heat for power in space and remote sensors.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"97":{"summary":"Berkelium is synthesized in reactors; enables discovery of heavier elements.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"98":{"summary":"Californium helps start reactors and probes materials via neutron emission.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"99":{"summary":"Einsteinium is highly radioactive and glows from decay heat.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"100":{"summary":"Fermium is created in nuclear explosions and reactors.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"101":{"summary":"Mendelevium honors the periodic table’s creator.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"102":{"summary":"Nobelium is named after Alfred Nobel of Nobel Prizes.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"103":{"summary":"Lawrencium’s behavior tested atomic theory at the series’ end.","uses":["Nuclear fuel (U, Th)","Smoke detectors (Am)","Space RTGs (Pu‑238)"],"where":["U and Th in minerals; others synthetic"],"hazards":["Ionizing radiation","Chemical toxicity"],"fun":"Technetium was the first element made artificially; many actinides are lab‑made."},"104":{"summary":"Rutherfordium confirms trends among group 4 superheavies.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"105":{"summary":"Dubnium is named after Dubna, Russia—home to a major lab.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"106":{"summary":"Seaborgium honors Glenn Seaborg, a pioneer in actinides.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"107":{"summary":"Bohrium recognizes Niels Bohr’s contributions to atomic theory.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"108":{"summary":"Hassium helped probe chemical behavior at high Z.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"109":{"summary":"Meitnerium honors Lise Meitner, co‑discoverer of nuclear fission.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"110":{"summary":"Darmstadtium is named for the German city of discovery.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"111":{"summary":"Roentgenium honors Wilhelm Röntgen, discoverer of X‑rays.","uses":["Stainless steels and superalloys","Catalytic converters or industrial catalysts","Electrical conductors (Cu, Ag)"],"where":["Sulfide and oxide ores"],"hazards":["Some compounds are toxic","Dusts can irritate lungs"],"fun":"Colorful ions make for striking solution chemistry."},"112":{"summary":"Copernicium tests relativistic effects on superheavy metals.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"113":{"summary":"Nihonium was the first element discovered in Asia to be named there.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"114":{"summary":"Flerovium may behave oddly due to relativistic effects.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"115":{"summary":"Moscovium is named after Moscow Oblast—home to JINR.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"116":{"summary":"Livermorium honors Lawrence Livermore National Laboratory.","uses":["Soldering and plating (Sn, Pb)","Transparent conductors (In in ITO)","Low-friction alloys"],"where":["Various ores and recycled materials"],"hazards":["Some (Pb, Tl) are toxic","Dust and fumes precautions"],"fun":"Gallium melts in your hand; tin ‘cries’ when bent."},"117":{"summary":"Tennessine sits under astatine—chemistry still under study.","uses":["Water treatment and disinfectants","Plastics (PVC) and nonstick coatings (PTFE)","Halogen lamps"],"where":["Sea salt deposits, brines"],"hazards":["Elemental forms can be corrosive/toxic","Some organohalogens persist in environment"],"fun":"Fluorine is the most reactive element known."},"118":{"summary":"Oganesson may not behave like a typical noble gas due to relativistic effects.","uses":["Neon signs, high‑intensity lamps","Shielding gas for welding (Ar)","Cryogenics (He)"],"where":["Air separation","Natural gas (He)"],"hazards":["Displace oxygen in enclosed spaces"],"fun":"Each noble gas gives a different colored glow in discharge tubes."}};

// Map ELEMENTS array by Z for name, category colours etc.
const EI_ELMAP = {};
...
function buildEIGrid() {
  ...
  // Position map from ELEMENTS (same row/col layout as main table)
  const posMap = {};
  ELEMENTS.forEach(e => { posMap[`${e.row},${e.col}`] = e; });

  for (let r = 1; r <= 9; r++) {
    // Section gap row between main body and lan/act series
    if (r === 8) {
      const gap = document.createElement('div');
    ...
    for (let c = 1; c <= 18; c++) {
      ...
      // Lan/Act series label rows (rows 8-9 in the grid = lan/act)
      if ((r === 8 || r === 9) && c === 1) {
        ...
        for (let cc = 4; cc <= 18; cc++) {
          ...
          em.className = 'ei-cell has-data';
          const rowZ = r === 8
            ? ELEMENTS.find(e => e.row === 8 && e.col === cc)
            : ELEMENTS.find(e => e.row === 9 && e.col === cc);
          if (rowZ) {
            em.dataset.z = rowZ.z;
            buildEICell(em, rowZ);
          } else {
            em.classList.replace('has-data', 'no-data');
      ...
      if (!mainEl) {
        // Empty grid slot (lanthanide/actinide gap placeholder in rows 6-7)
        const em = document.createElement('div');
        if (r >= 6 && c >= 4 && c <= 17) {
      ...
      const cell = document.createElement('div');
      cell.className = 'ei-cell has-data';
      cell.dataset.z = mainEl.z;
      buildEICell(cell, mainEl);
      grid.appendChild(cell);
    }
  }
}

// Populate one cell with symbol + hover tagline snippet
function buildEICell(cell, mainEl) {
  const z = mainEl.z;
  const hov = EI_HOVER[String(z)];
  const cat  = hov ? hov.category : '';
  const col  = EI_CAT_COL[cat] || '#94a3b8';

  cell.style.background = `color-mix(in srgb,${col} 22%,var(--surface2))`;
  cell.style.borderColor = `color-mix(in srgb,${col} 40%,transparent)`;
  ...
  // Tagline — first 4 words to fit in cell
  if (hov) {
    const tag = document.createElement('div');
    tag.className = 'ei-tagline';
    const words = hov.tagline.split(' ');
    tag.textContent = words.slice(0, 4).join(' ') + (words.length > 4 ? '…' : '');
...
function showEIDetail(z) {
  ...
  const col     = EI_CAT_COL[hov.category] || '#94a3b8';
  const catBg   = `color-mix(in srgb,${col} 18%,var(--surface2))`;

  const usesList  = card.uses.map(u =>
    `<li style="margin-bottom:3px;">${u}</li>`).join('');
  const whereList = card.where.map(w =>
    `<li style="margin-bottom:3px;">${w}</li>`).join('');
  const hazList   = card.hazards.map(h =>
    `<li style="margin-bottom:3px;">${h}</li>`).join('');
  const hovUseList= hov.uses.map(u =>
    `<span class="ei-use-chip" style="border-color:${col};color:${col};
      background:color-mix(in srgb,${col} 12%,var(--surface2));">${u}</span>`
  ).join('');

  content.innerHTML = `
    <!-- Hero -->
    <div class="ei-detail-hero" style="border-left:4px solid ${col};padding-left:10px;">
      <div class="ei-detail-sym" style="color:${col};">${mainEl.sym}</div>
      <div class="ei-detail-meta">
        <div class="ei-detail-name">${hov.name}</div>
        <div class="ei-detail-z" style="font-family:'Space Mono',monospace;font-size:0.58rem;
          color:var(--text-muted);">Z = ${z} &nbsp;·&nbsp; ${mainEl.mass}</div>
        <span class="ei-badge" style="margin-top:5px;display:inline-block;
          color:${col};border-color:${col};background:${catBg};">${hov.category}</span>
      </div>
    </div>

    <!-- Tagline -->
    <div style="background:${catBg};border:1px solid color-mix(in srgb,${col} 35%,var(--border));
      border-radius:8px;padding:9px 11px;font-size:0.78rem;font-style:italic;
      color:var(--text);line-height:1.45;">
      "${hov.tagline}"
    </div>

    <!-- Summary -->
    <div style="font-size:0.73rem;line-height:1.6;color:var(--text);">
      ${card.summary}
    </div>

    <!-- Uses chips (hover) -->
    <div>
      <div class="ei-section-label">Quick Uses</div>
    ...
    <!-- Real-world uses -->
    <div>
      <div class="ei-section-label">Real-World Uses</div>
      <ul style="margin:4px 0 0 14px;font-size:0.7rem;line-height:1.7;color:var(--text);">
        ${usesList}
      </ul>
    </div>
    ...
    <!-- Where found -->
    <div>
      <div class="ei-section-label">Where Found</div>
      <ul style="margin:4px 0 0 14px;font-size:0.7rem;line-height:1.7;color:var(--text);">
        ${whereList}
      </ul>
    </div>
    ...
    <!-- Safety -->
    <div style="background:color-mix(in srgb,#ef4444 12%,var(--surface2));
      border:1px solid color-mix(in srgb,#ef4444 35%,var(--border));
      border-radius:8px;padding:8px 11px;">
      <div class="ei-section-label" style="color:#ef4444;">⚠ Safety / Hazards</div>
      <ul style="margin:4px 0 0 14px;font-size:0.7rem;line-height:1.7;color:var(--text);">
        ${hazList}
      </ul>
      <div style="margin-top:5px;font-size:0.67rem;color:#f97316;">
        <strong>Note:</strong> ${hov.safety}
      </div>
    </div>

    <!-- Fun hook -->
    <div style="background:color-mix(in srgb,#f59e0b 12%,var(--surface2));
      border:1px solid color-mix(in srgb,#f59e0b 35%,var(--border));
      border-radius:8px;padding:9px 11px;">
      <div class="ei-section-label" style="color:#f59e0b;">⚡ Fun Fact</div>
      <div style="font-size:0.72rem;line-height:1.55;color:var(--text);margin-top:3px;">
        ${card.fun}
      </div>
    </div>

    <div class="ei-caption">Source: periodic-table-facts-dataset · CC BY 4.0</div>
  `;
}
